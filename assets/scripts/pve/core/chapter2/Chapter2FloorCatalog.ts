...
export const CHAPTER2_FLOORS: Record<number, Chapter2FloorDefinition> = {
  ...
  13: {
    ...
    equipmentIds: ['H06', 'T06', ...CHAPTER2_FLOOR13_BACKFLOW_EQUIPMENT_IDS],
    optionalObjectiveIds: [],
