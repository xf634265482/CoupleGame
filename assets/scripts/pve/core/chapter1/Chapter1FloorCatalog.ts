...
export const CHAPTER1_FLOORS: Record<number, Chapter1FloorDefinition> = {
  ...
  4: { floor:4,name:'夺令追逃',size:11,fogMode:'NONE',objectiveKind:'CHASE',player:c(0,10),criticalTargets:[c(1,9),c(10,0)],exitCells:[],chestCandidates:[],fixedWalls:[
    // 逃离点半围挡（南侧开口，可追逐进入）
    c(8,0),c(9,0),c(9,1),
    // 三道错口横墙：逼迫哨兵与玩家绕路，拉长战线（缺口错开）
