...
describe('Minghen trials',()=>{
 test('all 24 trials have explicit cloud-compatible counters',()=>{expect(Object.keys(MINGHEN_TRIAL_REQUIREMENTS)).toHaveLength(24);for(const requirement of Object.values(MINGHEN_TRIAL_REQUIREMENTS))expect(Object.keys(requirement).length).toBeGreaterThan(0);});
